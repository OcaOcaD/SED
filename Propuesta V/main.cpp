...
void opciones_avance(int a){
    ...
    do{
    	system("cls");
    	cout <<"opciones para alumno " << a << endl;
    	if(estado == 1){
			cout <<" >Dar de baja\n  Modif. avance\n  Inspeccionar";
		}else if(estado == 2){
			cout <<"  Dar de baja\n >Modif. avance\n  Inspeccionar";
        ...
        switch (caracter){
            ...
            case 13:
            	if(estado == 1){
					...
					//aun no disponible por incompatibilidad
					inspeccionar(a);
				}
                break;
        }
