...
void menu_listener(){
    ...
    do{
    	...
    	if(estado == 1){
    		cout <<"\t\t\t|SIAA|\n";
			cout <<"\t|Sistema Integral de Administracion de Alumnos|\n";
			cout <<" >Nuevo curso\n  Listado de cursos\n  Nuevo alumno\n  Listado de alumnos\n  Buscar alumno";
			cout <<"\n\n|Descripcion|\n";
			cout <<"\t-Dar de alta una Materia. -Asignar Horarios. - Asignar Ponderacion.";
		}else if(estado == 2){
			cout <<"\t\t\t|SIAA|\n";
			cout <<"\t|Sistema Integral de Administracion de Alumnos|\n";
			cout <<"  Nuevo curso\n >Listado de cursos\n  Nuevo alumno\n  Listado de alumnos\n  Buscar alumno";
			cout <<"\n\n|Descripcion|\n";
			cout <<"\t-Muestra los cursos disponibles. -Modifica Informacion del Curso.";
		}else if(estado == 3){
			cout <<"\t\t\t|SIAA|\n";
			cout <<"\t|Sistema Integral de Administracion de Alumnos|\n";
			cout <<"  Nuevo curso\n  Listado de cursos\n >Nuevo alumno\n  Listado de alumnos\n  Buscar alumno";
			cout <<"\n\n|Descripcion|\n";
			cout <<"\t-Dar de alta un Alumno. -Asigna Tareas. -Registra Ponderacion. -Asigna Asistencias";
		}else if(estado == 4){
			cout <<"\t\t\t|SIAA|\n";
			cout <<"\t|Sistema Integral de Administracion de Alumnos|\n";
			cout <<"  Nuevo curso\n  Listado de cursos\n  Nuevo alumno\n >Listado de alumnos\n  Buscar alumno";
			cout <<"\n\n|Descripcion|\n";
			cout <<"\t-Muestra los alumnos registrados. -Modifica informacion del Alumno";
		}else if(estado == 5){
			cout <<"\t\t\t|SIAA|\n";
			cout <<"\t|Sistema Integral de Administracion de Alumnos|\n";
			cout <<"  Nuevo curso\n  Listado de cursos\n  Nuevo alumno\n  Listado de alumnos\n >Buscar alumno";
			cout <<"\n\n|Descripcion|\n";
			cout <<"\t-Busqueda de un alumno mediante su Apellido o su codigo de estudiante";
		}
        caracter = getch();
        switch (caracter){
            case 72:
...
void listado_cursos(){
	...
	system("cls");
	cout << "    |NRC|\t  |Nombre del Curso|" << endl;
	c.listado();
	nodos = c.cantidad();
	estado = 1;
...
void opciones_alumno(int a){
    ...
    do{
    	system("cls");
    	cout <<"¿Que desea realizar?\t"<<"Alumno :"<<a<<endl;
    	if(estado == 1){
			cout <<" >Modificar datos del Alumno\n  Mostrar Informacion del Alumno";
		}else if(estado == 2){
			cout <<"  Modificar datos del Alumno\n >Mostrar Informacion del Alumno";
		}
        caracter = getch();
...
void opciones_avance(int cur, int al){
    ...
    do{
    	system("cls");
    	cout <<"Que desea realizar? " << al << endl;
    	if(estado == 1){
			cout <<" >Dar de baja\n  Modif. avance\n  Ver Kardex";
		}else if(estado == 2){
			cout <<"  Dar de baja\n >Modif. avance\n  Ver Kardex";
